...
const AddPostForm: FC<InjectedFormProps<AddPostFormPropsType>> = (props) => {
  return (
...
const AddPostReduxForm = reduxForm<AddPostFormPropsType>({ form: 'profileAddPostForm' })(AddPostForm)
type PropsType = {
  posts: Array<PostsType>
  // addNewPost: (values:number) => void
